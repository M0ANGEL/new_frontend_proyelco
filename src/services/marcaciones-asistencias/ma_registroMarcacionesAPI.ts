...
import {  ResponseMaRegistroMarcaciones } from "../types";

//llamar todas las categorias
export const getMaMaraciones = async (): Promise<ResponseMaRegistroMarcaciones> => {
  return await client_aistencia.get("administrarMarcaciones", {
