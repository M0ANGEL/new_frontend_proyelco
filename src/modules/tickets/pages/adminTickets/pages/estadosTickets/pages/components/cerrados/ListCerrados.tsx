...
import {
  DocumentoTkTicketRespuesta,
  getTkTicketEstados,
} from "@/services/tickets/administracionAPI";
import { ModalCerrados } from "./ModalCerrados";
...
export const ListCerrados = () => {
  ...
  return (
    <StyledCard title={"Panel de admistracion de tickets Cerrados"}>
      <SearchBar>
