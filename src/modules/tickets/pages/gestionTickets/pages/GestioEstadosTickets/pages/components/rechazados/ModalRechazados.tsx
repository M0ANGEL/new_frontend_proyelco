      ...
      >
        <Row gutter={24}>
          <Col xs={24} sm={10} style={{ width: "100%" }}>
            <StyledFormItem label="Categoría Padre">
              <Input allowClear disabled value={ticket.categoria} />
            </StyledFormItem>
          </Col>

          <Col xs={24} sm={14} style={{ width: "100%" }}>
            <StyledFormItem label="Subcategoría">
